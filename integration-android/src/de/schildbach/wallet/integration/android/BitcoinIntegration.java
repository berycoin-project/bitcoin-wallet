...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("berycoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Berycoin application found.\nPlease install Berycoin Wallet.", Toast.LENGTH_LONG).show();
